...
PmUtils.prototype = {
	...
	getDateTimeBack: function(str) {
		...
		return _date[0]+'/'+this.pad2(_date[1])+'/'+this.pad2(_date[2])+' '+this.pad2(_date[3])+':'+this.pad2(_date[4])+':00';
	},
	...
	removeDiacritics: function(str) {
	    for (var i=0; i<this.diacritrics.length; i++) {
	        str = str.replace(this.diacritrics[i].letters, this.diacritrics[i].base);
	    }
